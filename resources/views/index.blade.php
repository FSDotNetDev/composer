...
<html lang="en" class="no-js">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="{{asset('js/animate_header/css/default.css')}}" />
		<link rel="stylesheet" type="text/css" href="{{asset('js/animate_header/css/component.css')}}" />
	...
	<body>
		...
		<script src="{{asset('js/animate_header/js/classie.js')}}"></script>
		<script src="{{asset('js/animate_header/js/cbpAnimatedHeader.min.js')}}"></script>
...
po.src = '//127.0.0.1/livehelperchat-master/lhc_web/index.php/chat/getstatus/(click)/internal/(position)/bottom_right/(ma)/br/(top)/350/(units)/pixels/(leaveamessage)/true?r='+referrer+'&l='+location;
