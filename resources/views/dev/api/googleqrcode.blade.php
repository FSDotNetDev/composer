...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-8">
		...
		<ol class="breadcrumb">
			...
			<li>JS</li>
			<li class="active"><strong>Google QRCode</strong></li>
		</ol>
	</div>
</div>
<div class="row">
	<div class="col-lg-12">
		<div class="wrapper wrapper-content animated fadeInRight">
			<div class="ibox-content p-xl">
				<div class="row">
					<a href="{{ URL::to('https://developers.google.com/chart/infographics/docs/qr_codes#overview') }}" target="_blank">Read Document</a>
				</div>
				<hr>
				<img src="{{ $url }}" alt="">
			</div>
