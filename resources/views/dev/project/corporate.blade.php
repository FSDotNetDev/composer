...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-sm-4">
		<h2>Project Corporate</h2>
		<ol class="breadcrumb">
			<li><a href="index">Home</a></li>
			<li>Project</li>
			<li class="active"><strong>Corporate</strong></li>
		</ol>
	</div>
</div>
<div class="row">
					...
					<div class="row">
						<div class="col-lg-5">
							<dl class="dl-horizontal">
								...
								<dt>Version:</dt><dd><a href="http://www.mbookstore.com/corporate/index.php" target="_blank">Link</a></dd>
							</dl>
						</div>
