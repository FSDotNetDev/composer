...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-sm-4">
		...
		<ol class="breadcrumb">
			...
			<li>Project</li>
			<li class="active"><strong>POS</strong></li>
		</ol>
	</div>
</div>
<div class="row">
				...
				<div class="ibox-content">
					...
					<div class="row">
						...
						<div class="col-lg-7" id="cluster_info">
							<dl class="dl-horizontal">
								<dt>ดาวน์โหลด:</dt> 
								<dd><a href="{{ URL::to('https://github.com/jekkos/opensourcepos') }}" target="_blank" class="text-navy">Github</a></dd>
							</dl>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-5">
							<dl class="dl-horizontal">
								<dt>พัฒนาโดย:</dt><dd><a href="#" class="text-navy">jekkos</a></dd>
								<dt>ระยะเวลา:</dt><dd>LTS</dd>
								<dt>Version:</dt><dd>v1.0</dd>
							</dl>
						</div>
						<div class="col-lg-7" id="cluster_info">
							<dl class="dl-horizontal" >
						...
						<div class="col-lg-12">
							<dl class="dl-horizontal">
								...
								<dd>
									...
									<small>Project completed in <strong>100%</strong>. Remaining close the project, sign a contract and invoice.</small>
								</dd>
							</dl>
						</div>
					</div>
							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab-1">
									<div id="jstree1">
										...
										<a href="{{ URL::to('http://127.0.0.1/pos/index.php') }}" target="_blank">Go to Project</a>
									</div>
									...
									<div class="carousel slide" id="carousel2">
										...
										<div class="carousel-inner">
											<div class="item active">
												<img alt="image"  class="img-responsive" src="{{asset('/media/image/project/pos/index.png')}}">
											</div>
										</div>
